...
class CliqueOracleTest extends FlatSpec with Matchers with BlockGenerator with BlockStoreFixture {
  ...
  implicit val stateWithChainTime: Time[StateWithChain] =
    Time.stateTTime[BlockDag, Id](syncId, Time[Id])

  // See https://docs.google.com/presentation/d/1znz01SF1ljriPzbMoFV0J127ryPglUYLFyhvsb-ftQk/edit?usp=sharing slide 29 for diagram
  "Turan Oracle" should "detect finality as appropriate" in withStore[Id, Unit] {
    implicit blockStore =>
      ...
      val chain: BlockDag = createChain[StateWithChain].runS(initState)(syncId)
      ...
      implicit val turanOracleEffect = SafetyOracle.turanOracle[Id](syncId, blockStore)
      ...
      runSafetyOracle[Id](syncId, SafetyOracle[Id])
  }

  // See [[/docs/casper/images/no_finalizable_block_mistake_with_no_disagreement_check.png]]
  "Turan Oracle" should "detect possible disagreements appropriately" in withStore[Id, Unit] {
    implicit blockStore =>
      implicit val blockStoreChain =
        BlockGenerator.storeForStateWithChain[StateWithChain](blockStore)
      val v1     = ByteString.copyFromUtf8("Validator One")
      val v2     = ByteString.copyFromUtf8("Validator Two")
